...
let isOpenOverlayCard = false;
const handleOpenOverlayCard = () => {
  const overlay = document.querySelector('.overlay__bg');
  overlay.style.opacity = isOpenOverlayCard ? '0' : '1';
  const overlayContainer = document.querySelector('.overlay__wrapper'); 
  overlayContainer.style.transform = isOpenOverlayCard ? 'translateY(0)' : 'translateY(220%)';
  isOpenOverlayCard = !isOpenOverlayCard;
}
