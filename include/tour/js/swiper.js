...
const themestEle = document.querySelector(".themes-slide");

if (themestEle) {
  var swiper1 = new Swiper(themestEle.querySelector(".swiper"), {
    slidesPerView: 1,
    speed: 400,
    loop: true,
    spaceBetween: 20,
    ...
    navigation: {
      nextEl: themestEle.querySelector(".next"),
    },
  });
}
...
const introtEle = document.querySelector(".event-intro");

if (introtEle) {
  var swiper1 = new Swiper(introtEle.querySelector(".swiper"), {
    slidesPerView: 1,
    speed: 400,
    loop: true,
    navigation: {
      nextEl: introtEle.querySelector(".content-next"),
      prevEl: introtEle.querySelector(".content-prev"),
    },
    autoplay: {
      delay: 2000,
    },
  ...
  const btnPlay = document.querySelector(".event-intro .content-play");
